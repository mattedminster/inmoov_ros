...
echo_and_run cd "/home/robot/inmoov_ros/src/image_pipeline/camera_calibration"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/robot/inmoov_ros/build/image_pipeline/camera_calibration" \
    install \
    $DESTDIR_ARG \
