...
echo_and_run cd "/home/robot/inmoov_ros/src/image_recognition/tensorflow_ros"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/robot/inmoov_ros/build/image_recognition/tensorflow_ros" \
    install \
    $DESTDIR_ARG \
