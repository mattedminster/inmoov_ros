...
if(NOT "include;/usr/local/include/opencv;/usr/local/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'compressed_image_transport' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/inmoov_ros/install/${idir}'.  Ask the maintainer 'David Gossow <dgossow@willowgarage.com>' to fix it.")
    endif()
