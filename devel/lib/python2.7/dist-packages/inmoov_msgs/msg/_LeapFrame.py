...
"""autogenerated by genpy from inmoov_msgs/LeapFrame.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','float64','uint32','geometry_msgs/Vector3[]','float64','geometry_msgs/Vector3','time','inmoov_msgs/LeapGesture[]','inmoov_msgs/LeapHand[]','inmoov_msgs/LeapPointable[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_dI().pack(_x.currentFrameRate, _x.ID))
      length = len(self.r)
      ...
      _x = self
      buff.write(_get_struct_4d2I().pack(_x.s, _x.t.x, _x.t.y, _x.t.z, _x.timestamp.secs, _x.timestamp.nsecs))
      ...
      for val1 in self.gestures:
        ...
        _x = _v2
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        buff.write(_get_struct_I().pack(val1.duration))
        ...
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _x = val1
        buff.write(_get_struct_3d().pack(_x.progress, _x.radius, _x.speed))
      ...
      for val1 in self.hands:
        for val2 in val1.armBasis:
          ...
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _x = val1
        buff.write(_get_struct_2d().pack(_x.armWidth, _x.confidence))
        _v6 = val1.direction
        _x = _v6
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v7 = val1.elbow
        ...
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _x = val1
        buff.write(_get_struct_dI().pack(_x.grabStrength, _x.ID))
        _v8 = val1.palmNormal
        _x = _v8
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        ...
        _x = _v10
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        buff.write(_get_struct_d().pack(val1.pinchStrength))
        for val2 in val1.r:
          _x = val2
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        buff.write(_get_struct_d().pack(val1.s))
        _v11 = val1.sphereCenter
        _x = _v11
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        buff.write(_get_struct_d().pack(val1.sphereRadius))
        ...
        _x = _v13
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        buff.write(_get_struct_d().pack(val1.timeVisible))
        _x = val1.handType
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      for val1 in self.pointables:
        ...
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _x = val1
        buff.write(_get_struct_B2Id().pack(_x.extended, _x.handId, _x.ID, _x.length))
        ...
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _x = val1
        buff.write(_get_struct_Bd().pack(_x.tool, _x.touchDistance))
        _x = val1.touchZone
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
        _x = val1
        buff.write(_get_struct_Id().pack(_x.pointableType, _x.width))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.currentFrameRate, _x.ID,) = _get_struct_dI().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.r = []
      ...
      (_x.s, _x.t.x, _x.t.y, _x.t.z, _x.timestamp.secs, _x.timestamp.nsecs,) = _get_struct_4d2I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.gestures = []
      for i in range(0, length):
        val1 = inmoov_msgs.msg.LeapGesture()
        _v24 = val1.center
        _x = _v24
        start = end
        end += 24
        ...
        (_x.progress, _x.radius, _x.speed,) = _get_struct_3d().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        (_x.armWidth, _x.confidence,) = _get_struct_2d().unpack(str[start:end])
        _v29 = val1.direction
        _x = _v29
        start = end
        end += 24
        ...
        (_x.grabStrength, _x.ID,) = _get_struct_dI().unpack(str[start:end])
        ...
        (val1.pinchStrength,) = _get_struct_d().unpack(str[start:end])
        val1.r = []
        for i in range(0, 3):
          val2 = geometry_msgs.msg.Vector3()
          _x = val2
        ...
        (val1.s,) = _get_struct_d().unpack(str[start:end])
        ...
        (val1.sphereRadius,) = _get_struct_d().unpack(str[start:end])
        ...
        (val1.timeVisible,) = _get_struct_d().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
      ...
      self.pointables = []
      for i in range(0, length):
        val1 = inmoov_msgs.msg.LeapPointable()
        ...
        (_x.extended, _x.handId, _x.ID, _x.length,) = _get_struct_B2Id().unpack(str[start:end])
        ...
        (_x.tool, _x.touchDistance,) = _get_struct_Bd().unpack(str[start:end])
        ...
        (_x.pointableType, _x.width,) = _get_struct_Id().unpack(str[start:end])
