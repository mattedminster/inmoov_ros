...
class MotorCommand(genpy.Message):
  _md5sum = "eb0b08dd62a5eaff08551ecb80949ef6"
  _type = "inmoov_msgs/MotorCommand"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """uint8   id                      # motor id
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2Bf().pack(_x.id, _x.parameter, _x.value))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.parameter, _x.value,) = _get_struct_2Bf().unpack(str[start:end])
      return self
