...
"""autogenerated by genpy from inmoov_msgs/LeapGesture.msg. Do not edit."""
import sys
...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_6dI().pack(_x.center.x, _x.center.y, _x.center.z, _x.direction.x, _x.direction.y, _x.direction.z, _x.duration))
      length = len(self.handIds)
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(struct.pack(pattern, *self.handIds))
      _x = self
      buff.write(_get_struct_I3d().pack(_x.ID, _x.normal.x, _x.normal.y, _x.normal.z))
      length = len(self.pointableIds)
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(struct.pack(pattern, *self.pointableIds))
      _x = self
      buff.write(_get_struct_9d().pack(_x.position.x, _x.position.y, _x.position.z, _x.progress, _x.radius, _x.speed, _x.startPosition.x, _x.startPosition.y, _x.startPosition.z))
      _x = self.state
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.center.x, _x.center.y, _x.center.z, _x.direction.x, _x.direction.y, _x.direction.z, _x.duration,) = _get_struct_6dI().unpack(str[start:end])
      start = end
      end += 4
      ...
      (_x.ID, _x.normal.x, _x.normal.y, _x.normal.z,) = _get_struct_I3d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sI'%length
      ...
      (_x.position.x, _x.position.y, _x.position.z, _x.progress, _x.radius, _x.speed, _x.startPosition.x, _x.startPosition.y, _x.startPosition.z,) = _get_struct_9d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
