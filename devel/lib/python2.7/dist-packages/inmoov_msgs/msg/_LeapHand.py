...
"""autogenerated by genpy from inmoov_msgs/LeapHand.msg. Do not edit."""
import sys
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.armBasis is None:
        self.armBasis = [geometry_msgs.msg.Vector3() for _ in range(3)]
      ...
      if self.r is None:
        self.r = [geometry_msgs.msg.Vector3() for _ in range(3)]
      if self.s is None:
        self.s = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_9dI10d().pack(_x.armWidth, _x.confidence, _x.direction.x, _x.direction.y, _x.direction.z, _x.elbow.x, _x.elbow.y, _x.elbow.z, _x.grabStrength, _x.ID, _x.palmNormal.x, _x.palmNormal.y, _x.palmNormal.z, _x.palmPosition.x, _x.palmPosition.y, _x.palmPosition.z, _x.palmVelocity.x, _x.palmVelocity.y, _x.palmVelocity.z, _x.pinchStrength))
      for val1 in self.r:
        _x = val1
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      _x = self
      buff.write(_get_struct_12d().pack(_x.s, _x.sphereCenter.x, _x.sphereCenter.y, _x.sphereCenter.z, _x.sphereRadius, _x.stabilizedPalmPosition.x, _x.stabilizedPalmPosition.y, _x.stabilizedPalmPosition.z, _x.t.x, _x.t.y, _x.t.z, _x.timeVisible))
      _x = self.handType
      length = len(_x)
      ...
      _x = self
      buff.write(_get_struct_3d().pack(_x.wrist.x, _x.wrist.y, _x.wrist.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.s, _x.sphereCenter.x, _x.sphereCenter.y, _x.sphereCenter.z, _x.sphereRadius, _x.stabilizedPalmPosition.x, _x.stabilizedPalmPosition.y, _x.stabilizedPalmPosition.z, _x.t.x, _x.t.y, _x.t.z, _x.timeVisible,) = _get_struct_12d().unpack(str[start:end])
      start = end
      end += 4
      ...
      (_x.wrist.x, _x.wrist.y, _x.wrist.z,) = _get_struct_3d().unpack(str[start:end])
      return self
...
def _get_struct_I():
    ...
    return _struct_I
_struct_9dI10d = None
def _get_struct_9dI10d():
    global _struct_9dI10d
    if _struct_9dI10d is None:
        _struct_9dI10d = struct.Struct("<9dI10d")
    return _struct_9dI10d
_struct_12d = None
def _get_struct_12d():
    global _struct_12d
