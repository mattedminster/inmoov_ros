...
"""autogenerated by genpy from inmoov_msgs/LeapPointable.msg. Do not edit."""
import sys
...
class LeapPointable(genpy.Message):
  ...
  _type = "inmoov_msgs/LeapPointable"
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.metacarpalBasis is None:
        self.metacarpalBasis = [geometry_msgs.msg.Vector3() for _ in range(3)]
      if self.proximalBasis is None:
        self.proximalBasis = [geometry_msgs.msg.Vector3() for _ in range(3)]
      if self.intermediateBasis is None:
        self.intermediateBasis = [geometry_msgs.msg.Vector3() for _ in range(3)]
      if self.distalBasis is None:
        self.distalBasis = [geometry_msgs.msg.Vector3() for _ in range(3)]
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.distalBasis:
        ...
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      _x = self
      buff.write(_get_struct_12dB2I17dBd().pack(_x.btipPosition.x, _x.btipPosition.y, _x.btipPosition.z, _x.carpPosition.x, _x.carpPosition.y, _x.carpPosition.z, _x.dipPosition.x, _x.dipPosition.y, _x.dipPosition.z, _x.direction.x, _x.direction.y, _x.direction.z, _x.extended, _x.handId, _x.ID, _x.length, _x.mcpPosition.x, _x.mcpPosition.y, _x.mcpPosition.z, _x.pipPosition.x, _x.pipPosition.y, _x.pipPosition.z, _x.stabilizedTipPosition.x, _x.stabilizedTipPosition.y, _x.stabilizedTipPosition.z, _x.timeVisible, _x.tipPosition.x, _x.tipPosition.y, _x.tipPosition.z, _x.tipVelocity.x, _x.tipVelocity.y, _x.tipVelocity.z, _x.tool, _x.touchDistance))
      _x = self.touchZone
      length = len(_x)
...
def _get_struct_Id():
    ...
    return _struct_Id
_struct_12dB2I17dBd = None
def _get_struct_12dB2I17dBd():
    global _struct_12dB2I17dBd
    if _struct_12dB2I17dBd is None:
        _struct_12dB2I17dBd = struct.Struct("<12dB2I17dBd")
    return _struct_12dB2I17dBd
_struct_3d = None
def _get_struct_3d():
    global _struct_3d
