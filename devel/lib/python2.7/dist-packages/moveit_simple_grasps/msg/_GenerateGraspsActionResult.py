...
"""autogenerated by genpy from moveit_simple_grasps/GenerateGraspsActionResult.msg. Do not edit."""
import sys
...
class GenerateGraspsActionResult(genpy.Message):
  ...
  _type = "moveit_simple_grasps/GenerateGraspsActionResult"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','moveit_simple_grasps/GenerateGraspsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = moveit_simple_grasps.msg.GenerateGraspsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = moveit_simple_grasps.msg.GenerateGraspsResult()
