...
"""autogenerated by genpy from haf_grasping/CalcGraspPointsServerActionFeedback.msg. Do not edit."""
import sys
...
class CalcGraspPointsServerActionFeedback(genpy.Message):
  _md5sum = "b4cb210609601317f8a72e91950d4c0b"
  _type = "haf_grasping/CalcGraspPointsServerActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','haf_grasping/CalcGraspPointsServerFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CalcGraspPointsServerActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = haf_grasping.msg.CalcGraspPointsServerFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = haf_grasping.msg.CalcGraspPointsServerFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.feedback.feedback.data
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.feedback.feedback.data = str[start:end].decode('utf-8')
      else:
        self.feedback.feedback.data = str[start:end]
      return self
