...
"""autogenerated by genpy from moveit_grasps/GenerateGraspsActionFeedback.msg. Do not edit."""
import sys
...
class GenerateGraspsActionFeedback(genpy.Message):
  _md5sum = "947765100fcb339c2c35349f12eee057"
  _type = "moveit_grasps/GenerateGraspsActionFeedback"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','moveit_grasps/GenerateGraspsFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GenerateGraspsActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = moveit_grasps.msg.GenerateGraspsFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = moveit_grasps.msg.GenerateGraspsFeedback()
