...
"""autogenerated by genpy from moveit_grasps/GenerateGraspsActionResult.msg. Do not edit."""
import sys
...
class GenerateGraspsActionResult(genpy.Message):
  _md5sum = "3e5cdae81cffa49b72e6fc3e16366194"
  _type = "moveit_grasps/GenerateGraspsActionResult"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','moveit_grasps/GenerateGraspsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GenerateGraspsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = moveit_grasps.msg.GenerateGraspsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = moveit_grasps.msg.GenerateGraspsResult()
