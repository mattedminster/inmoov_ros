...
class Recognition(genpy.Message):
  _md5sum = "4b43115e31295aecb76e808f68d9d2b7"
...
bool do_rectify
"""
  __slots__ = ['categorical_distribution','roi']
  _slot_types = ['image_recognition_msgs/CategoricalDistribution','sensor_msgs/RegionOfInterest']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_f4IB().pack(_x.categorical_distribution.unknown_probability, _x.roi.x_offset, _x.roi.y_offset, _x.roi.height, _x.roi.width, _x.roi.do_rectify))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.categorical_distribution.unknown_probability, _x.roi.x_offset, _x.roi.y_offset, _x.roi.height, _x.roi.width, _x.roi.do_rectify,) = _get_struct_f4IB().unpack(str[start:end])
