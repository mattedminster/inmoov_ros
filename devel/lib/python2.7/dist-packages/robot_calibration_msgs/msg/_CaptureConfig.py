...
"""autogenerated by genpy from robot_calibration_msgs/CaptureConfig.msg. Do not edit."""
import sys
...
class CaptureConfig(genpy.Message):
  _md5sum = "f347b595aa5cb3d9820e25d6d41f25cd"
  _type = "robot_calibration_msgs/CaptureConfig"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Pose the robot should be put in for this sample
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CaptureConfig, self).__init__(*args, **kwds)
