...
(cl:defclass <LeapFrame> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (gestures
    :reader gestures
    :initarg :gestures
    :type (cl:vector inmoov_msgs-msg:LeapGesture)
   :initform (cl:make-array 0 :element-type 'inmoov_msgs-msg:LeapGesture :initial-element (cl:make-instance 'inmoov_msgs-msg:LeapGesture)))
   (hands
    :reader hands
    :initarg :hands
    :type (cl:vector inmoov_msgs-msg:LeapHand)
   :initform (cl:make-array 0 :element-type 'inmoov_msgs-msg:LeapHand :initial-element (cl:make-instance 'inmoov_msgs-msg:LeapHand)))
   (pointables
    :reader pointables
    :initarg :pointables
    :type (cl:vector inmoov_msgs-msg:LeapPointable)
   :initform (cl:make-array 0 :element-type 'inmoov_msgs-msg:LeapPointable :initial-element (cl:make-instance 'inmoov_msgs-msg:LeapPointable))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LeapFrame>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LeapFrame)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name inmoov_msgs-msg:<LeapFrame> is deprecated: use inmoov_msgs-msg:LeapFrame instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <LeapFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inmoov_msgs-msg:header-val is deprecated.  Use inmoov_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'currentFrameRate-val :lambda-list '(m))
(cl:defmethod currentFrameRate-val ((m <LeapFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inmoov_msgs-msg:currentFrameRate-val is deprecated.  Use inmoov_msgs-msg:currentFrameRate instead.")
  (currentFrameRate m))
...
(cl:defmethod r-val ((m <LeapFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inmoov_msgs-msg:r-val is deprecated.  Use inmoov_msgs-msg:r instead.")
  (r m))

(cl:ensure-generic-function 's-val :lambda-list '(m))
(cl:defmethod s-val ((m <LeapFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inmoov_msgs-msg:s-val is deprecated.  Use inmoov_msgs-msg:s instead.")
  (s m))

(cl:ensure-generic-function 't-val :lambda-list '(m))
(cl:defmethod t-val ((m <LeapFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inmoov_msgs-msg:t-val is deprecated.  Use inmoov_msgs-msg:t instead.")
  (t m))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <LeapFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inmoov_msgs-msg:timestamp-val is deprecated.  Use inmoov_msgs-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'gestures-val :lambda-list '(m))
(cl:defmethod gestures-val ((m <LeapFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inmoov_msgs-msg:gestures-val is deprecated.  Use inmoov_msgs-msg:gestures instead.")
  (gestures m))

(cl:ensure-generic-function 'hands-val :lambda-list '(m))
(cl:defmethod hands-val ((m <LeapFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inmoov_msgs-msg:hands-val is deprecated.  Use inmoov_msgs-msg:hands instead.")
  (hands m))

(cl:ensure-generic-function 'pointables-val :lambda-list '(m))
(cl:defmethod pointables-val ((m <LeapFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inmoov_msgs-msg:pointables-val is deprecated.  Use inmoov_msgs-msg:pointables instead.")
  (pointables m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LeapFrame>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'gestures)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'inmoov_msgs-msg:LeapGesture))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  (cl:let ((__ros_arr_len 0))
    (cl:setf (cl:ldb (cl:byte 8 0) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) __ros_arr_len) (cl:read-byte istream))
  ...
  (cl:let ((vals (cl:slot-value msg 'hands)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'inmoov_msgs-msg:LeapHand))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  (cl:let ((__ros_arr_len 0))
    (cl:setf (cl:ldb (cl:byte 8 0) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) __ros_arr_len) (cl:read-byte istream))
  ...
  (cl:let ((vals (cl:slot-value msg 'pointables)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'inmoov_msgs-msg:LeapPointable))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
