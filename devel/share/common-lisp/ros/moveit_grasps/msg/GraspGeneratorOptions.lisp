...
(cl:defmethod cl:initialize-instance :after ((m <GraspGeneratorOptions>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GraspGeneratorOptions)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name moveit_grasps-msg:<GraspGeneratorOptions> is deprecated: use moveit_grasps-msg:GraspGeneratorOptions instead.")))

(cl:ensure-generic-function 'grasp_axis-val :lambda-list '(m))
(cl:defmethod grasp_axis-val ((m <GraspGeneratorOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_grasps-msg:grasp_axis-val is deprecated.  Use moveit_grasps-msg:grasp_axis instead.")
  (grasp_axis m))

(cl:ensure-generic-function 'grasp_direction-val :lambda-list '(m))
(cl:defmethod grasp_direction-val ((m <GraspGeneratorOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_grasps-msg:grasp_direction-val is deprecated.  Use moveit_grasps-msg:grasp_direction instead.")
  (grasp_direction m))

(cl:ensure-generic-function 'grasp_rotation-val :lambda-list '(m))
(cl:defmethod grasp_rotation-val ((m <GraspGeneratorOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_grasps-msg:grasp_rotation-val is deprecated.  Use moveit_grasps-msg:grasp_rotation instead.")
  (grasp_rotation m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GraspGeneratorOptions>)))
  ...
  "moveit_grasps/GraspGeneratorOptions")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GraspGeneratorOptions)))
  "Returns string type for a message object of type 'GraspGeneratorOptions"
  "moveit_grasps/GraspGeneratorOptions")
