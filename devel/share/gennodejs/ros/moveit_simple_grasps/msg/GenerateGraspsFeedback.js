...
class GenerateGraspsFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GenerateGraspsFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GenerateGraspsFeedback(null);
...
module.exports = GenerateGraspsFeedback;
