...
class Observation {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('ext_camera_info')) {
        this.ext_camera_info = initObj.ext_camera_info
      }
      else {
        this.ext_camera_info = new ExtendedCameraInfo();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [ext_camera_info]
    bufferOffset = ExtendedCameraInfo.serialize(obj.ext_camera_info, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.features[i] = geometry_msgs.msg.PointStamped.deserialize(buffer, bufferOffset)
    }
    // Deserialize message field [ext_camera_info]
    data.ext_camera_info = ExtendedCameraInfo.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += ExtendedCameraInfo.getMessageSize(object.ext_camera_info);
  ...
  static Resolve(msg) {
    ...
    if (msg.features !== undefined) {
      ...
      for (let i = 0; i < resolved.features.length; ++i) {
        resolved.features[i] = geometry_msgs.msg.PointStamped.Resolve(msg.features[i]);
      }
    }
    else {
      resolved.features = []
    ...
    if (msg.ext_camera_info !== undefined) {
      resolved.ext_camera_info = ExtendedCameraInfo.Resolve(msg.ext_camera_info)
    }
    else {
      resolved.ext_camera_info = new ExtendedCameraInfo()
    }
