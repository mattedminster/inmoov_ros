...
class ExtendedCameraInfo {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ExtendedCameraInfo
    ...
    obj.parameters.forEach((val) => {
      bufferOffset = CameraParameter.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ExtendedCameraInfo
    let len;
    let data = new ExtendedCameraInfo(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.parameters[i] = CameraParameter.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.parameters.forEach((val) => {
      length += CameraParameter.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static md5sum() {
    ...
    return 'd35c5c887e3d90c7f6f9c5a697f44485';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExtendedCameraInfo(null);
    ...
    if (msg.parameters !== undefined) {
      ...
      for (let i = 0; i < resolved.parameters.length; ++i) {
        resolved.parameters[i] = CameraParameter.Resolve(msg.parameters[i]);
      }
    }
    else {
      resolved.parameters = []
...
module.exports = ExtendedCameraInfo;
