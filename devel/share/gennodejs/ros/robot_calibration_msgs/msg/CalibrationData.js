...
class CalibrationData {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CalibrationData
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CalibrationData
    let len;
    let data = new CalibrationData(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CalibrationData(null);
