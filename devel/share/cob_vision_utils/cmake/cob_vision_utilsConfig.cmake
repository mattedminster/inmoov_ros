...
if("TRUE" STREQUAL "TRUE")
  set(cob_vision_utils_SOURCE_PREFIX /home/robot/inmoov_ros/src/cob_perception_common/cob_vision_utils)
  set(cob_vision_utils_DEVEL_PREFIX /home/robot/inmoov_ros/devel)
  ...
  set(cob_vision_utils_INSTALL_PREFIX /home/robot/inmoov_ros/install)
...
if(NOT "/home/robot/inmoov_ros/src/cob_perception_common/cob_vision_utils/common/include;/home/robot/inmoov_ros/src/cob_perception_common/cob_vision_utils/ros/include;/usr/local/include/opencv;/usr/local/include;/usr/include " STREQUAL " ")
  set(cob_vision_utils_INCLUDE_DIRS "")
  set(_include_dirs "/home/robot/inmoov_ros/src/cob_perception_common/cob_vision_utils/common/include;/home/robot/inmoov_ros/src/cob_perception_common/cob_vision_utils/ros/include;/usr/local/include/opencv;/usr/local/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cob_vision_utils' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/inmoov_ros/src/cob_perception_common/cob_vision_utils/${idir}'.  Ask the maintainer 'Richard Bormann <rmb@ipa.fhg.de>' to fix it.")
    endif()
    _list_append_unique(cob_vision_utils_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "cob_vision_utils;/usr/local/lib/libopencv_videostab.so.2.4.13;/usr/local/lib/libopencv_video.so.2.4.13;/usr/local/lib/libopencv_superres.so.2.4.13;/usr/local/lib/libopencv_stitching.so.2.4.13;/usr/local/lib/libopencv_photo.so.2.4.13;/usr/local/lib/libopencv_ocl.so.2.4.13;/usr/local/lib/libopencv_objdetect.so.2.4.13;/usr/local/lib/libopencv_nonfree.so.2.4.13;/usr/local/lib/libopencv_ml.so.2.4.13;/usr/local/lib/libopencv_legacy.so.2.4.13;/usr/local/lib/libopencv_imgproc.so.2.4.13;/usr/local/lib/libopencv_highgui.so.2.4.13;/usr/local/lib/libopencv_gpu.so.2.4.13;/usr/local/lib/libopencv_flann.so.2.4.13;/usr/local/lib/libopencv_features2d.so.2.4.13;/usr/local/lib/libopencv_core.so.2.4.13;/usr/local/lib/libopencv_contrib.so.2.4.13;/usr/local/lib/libopencv_calib3d.so.2.4.13;/usr/lib/x86_64-linux-gnu/libtinyxml.so")
