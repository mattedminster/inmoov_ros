...
if("TRUE" STREQUAL "TRUE")
  set(moveit_fake_controller_manager_SOURCE_PREFIX /home/robot/inmoov_ros/src/moveit/moveit_plugins/moveit_fake_controller_manager)
  set(moveit_fake_controller_manager_DEVEL_PREFIX /home/robot/inmoov_ros/devel)
  ...
  set(moveit_fake_controller_manager_INSTALL_PREFIX /home/robot/inmoov_ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_fake_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/inmoov_ros/src/moveit/moveit_plugins/moveit_fake_controller_manager/${idir}'.  Ask the maintainer 'Michael Görner <me@v4hn.de>' to fix it.")
    endif()
