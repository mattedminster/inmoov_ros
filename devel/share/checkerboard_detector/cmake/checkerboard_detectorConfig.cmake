...
if("TRUE" STREQUAL "TRUE")
  set(checkerboard_detector_SOURCE_PREFIX /home/robot/inmoov_ros/src/checkerboard_detector)
  set(checkerboard_detector_DEVEL_PREFIX /home/robot/inmoov_ros/devel)
  ...
  set(checkerboard_detector_INSTALL_PREFIX /home/robot/inmoov_ros/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'checkerboard_detector' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Kei Okada <k-okada@jsk.t.u-tokyo.ac.jp>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'checkerboard_detector' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/inmoov_ros/src/checkerboard_detector/${idir}'.  Ask the maintainer 'Kei Okada <k-okada@jsk.t.u-tokyo.ac.jp>' to fix it.")
    endif()
