...
if("TRUE" STREQUAL "TRUE")
  set(moveit_tutorials_SOURCE_PREFIX /home/robot/inmoov_ros/src/moveit_tutorials)
  set(moveit_tutorials_DEVEL_PREFIX /home/robot/inmoov_ros/devel)
  ...
  set(moveit_tutorials_INSTALL_PREFIX /home/robot/inmoov_ros/install)
...
if(NOT "/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/inmoov_ros/src/moveit_tutorials/${idir}'.  Ask the maintainer 'Dave Coleman <dave@dav.ee>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
