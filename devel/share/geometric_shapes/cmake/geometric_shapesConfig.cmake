...
if("TRUE" STREQUAL "TRUE")
  set(geometric_shapes_SOURCE_PREFIX /home/robot/inmoov_ros/src/geometric_shapes)
  set(geometric_shapes_DEVEL_PREFIX /home/robot/inmoov_ros/devel)
  ...
  set(geometric_shapes_INSTALL_PREFIX /home/robot/inmoov_ros/install)
...
if(NOT "/home/robot/inmoov_ros/src/geometric_shapes/include;/usr/include/eigen3;/opt/ros/kinetic/include;/usr/include " STREQUAL " ")
  set(geometric_shapes_INCLUDE_DIRS "")
  set(_include_dirs "/home/robot/inmoov_ros/src/geometric_shapes/include;/usr/include/eigen3;/opt/ros/kinetic/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'geometric_shapes' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Dave Coleman <dave@dav.ee>, Isaac I. Y. Saito <130s@2000.jukuin.keio.ac.jp>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'geometric_shapes' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/inmoov_ros/src/geometric_shapes/${idir}'.  Ask the maintainer 'Dave Coleman <dave@dav.ee>, Isaac I. Y. Saito <130s@2000.jukuin.keio.ac.jp>' to fix it.")
    endif()
