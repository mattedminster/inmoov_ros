// Generated by gencpp from file inmoov_msgs/LeapPointable.msg
// DO NOT EDIT!


#ifndef INMOOV_MSGS_MESSAGE_LEAPPOINTABLE_H
#define INMOOV_MSGS_MESSAGE_LEAPPOINTABLE_H
...
struct LeapPointable_
{
  ...
  typedef boost::shared_ptr< ::inmoov_msgs::LeapPointable_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::inmoov_msgs::LeapPointable_<ContainerAllocator> const> ConstPtr;

}; // struct LeapPointable_

typedef ::inmoov_msgs::LeapPointable_<std::allocator<void> > LeapPointable;

typedef boost::shared_ptr< ::inmoov_msgs::LeapPointable > LeapPointablePtr;
typedef boost::shared_ptr< ::inmoov_msgs::LeapPointable const> LeapPointableConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::inmoov_msgs::LeapPointable_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::inmoov_msgs::LeapPointable_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::inmoov_msgs::LeapPointable_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::inmoov_msgs::LeapPointable_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::inmoov_msgs::LeapPointable_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::inmoov_msgs::LeapPointable_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::inmoov_msgs::LeapPointable_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::inmoov_msgs::LeapPointable_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::inmoov_msgs::LeapPointable_<ContainerAllocator> >
{
  ...
  static const char* value(const ::inmoov_msgs::LeapPointable_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x17349b2abd8a7a1fULL;
  static const uint64_t static_value2 = 0x31586b0c52c91cb7ULL;
};

template<class ContainerAllocator>
struct DataType< ::inmoov_msgs::LeapPointable_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::inmoov_msgs::LeapPointable_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::inmoov_msgs::LeapPointable_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::inmoov_msgs::LeapPointable_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::inmoov_msgs::LeapPointable_<ContainerAllocator>& v)
  {
...
#endif // INMOOV_MSGS_MESSAGE_LEAPPOINTABLE_H
