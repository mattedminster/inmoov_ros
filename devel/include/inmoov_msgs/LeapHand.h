// Generated by gencpp from file inmoov_msgs/LeapHand.msg
// DO NOT EDIT!


#ifndef INMOOV_MSGS_MESSAGE_LEAPHAND_H
#define INMOOV_MSGS_MESSAGE_LEAPHAND_H
...
struct LeapHand_
{
  ...
  typedef boost::shared_ptr< ::inmoov_msgs::LeapHand_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::inmoov_msgs::LeapHand_<ContainerAllocator> const> ConstPtr;

}; // struct LeapHand_

typedef ::inmoov_msgs::LeapHand_<std::allocator<void> > LeapHand;

typedef boost::shared_ptr< ::inmoov_msgs::LeapHand > LeapHandPtr;
typedef boost::shared_ptr< ::inmoov_msgs::LeapHand const> LeapHandConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::inmoov_msgs::LeapHand_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::inmoov_msgs::LeapHand_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::inmoov_msgs::LeapHand_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::inmoov_msgs::LeapHand_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::inmoov_msgs::LeapHand_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::inmoov_msgs::LeapHand_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::inmoov_msgs::LeapHand_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::inmoov_msgs::LeapHand_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::inmoov_msgs::LeapHand_<ContainerAllocator> >
{
  ...
  static const char* value(const ::inmoov_msgs::LeapHand_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe1f168193e08481cULL;
  static const uint64_t static_value2 = 0x556346f6b4c70f16ULL;
};

template<class ContainerAllocator>
struct DataType< ::inmoov_msgs::LeapHand_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::inmoov_msgs::LeapHand_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::inmoov_msgs::LeapHand_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::inmoov_msgs::LeapHand_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::inmoov_msgs::LeapHand_<ContainerAllocator>& v)
  {
...
#endif // INMOOV_MSGS_MESSAGE_LEAPHAND_H
