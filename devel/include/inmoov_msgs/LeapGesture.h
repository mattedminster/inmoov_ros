// Generated by gencpp from file inmoov_msgs/LeapGesture.msg
// DO NOT EDIT!


#ifndef INMOOV_MSGS_MESSAGE_LEAPGESTURE_H
#define INMOOV_MSGS_MESSAGE_LEAPGESTURE_H
...
struct LeapGesture_
{
  ...
  typedef boost::shared_ptr< ::inmoov_msgs::LeapGesture_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::inmoov_msgs::LeapGesture_<ContainerAllocator> const> ConstPtr;

}; // struct LeapGesture_

typedef ::inmoov_msgs::LeapGesture_<std::allocator<void> > LeapGesture;

typedef boost::shared_ptr< ::inmoov_msgs::LeapGesture > LeapGesturePtr;
typedef boost::shared_ptr< ::inmoov_msgs::LeapGesture const> LeapGestureConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::inmoov_msgs::LeapGesture_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::inmoov_msgs::LeapGesture_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::inmoov_msgs::LeapGesture_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::inmoov_msgs::LeapGesture_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::inmoov_msgs::LeapGesture_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::inmoov_msgs::LeapGesture_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::inmoov_msgs::LeapGesture_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::inmoov_msgs::LeapGesture_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::inmoov_msgs::LeapGesture_<ContainerAllocator> >
{
  ...
  static const char* value(const ::inmoov_msgs::LeapGesture_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x967e671f82992095ULL;
  static const uint64_t static_value2 = 0xab401d46b1c41311ULL;
};

template<class ContainerAllocator>
struct DataType< ::inmoov_msgs::LeapGesture_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::inmoov_msgs::LeapGesture_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::inmoov_msgs::LeapGesture_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::inmoov_msgs::LeapGesture_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::inmoov_msgs::LeapGesture_<ContainerAllocator>& v)
  {
    s << indent << "center: ";
    s << std::endl;
...
#endif // INMOOV_MSGS_MESSAGE_LEAPGESTURE_H
