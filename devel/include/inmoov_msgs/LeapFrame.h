// Generated by gencpp from file inmoov_msgs/LeapFrame.msg
// DO NOT EDIT!


#ifndef INMOOV_MSGS_MESSAGE_LEAPFRAME_H
#define INMOOV_MSGS_MESSAGE_LEAPFRAME_H
...
#include <geometry_msgs/Vector3.h>
#include <inmoov_msgs/LeapGesture.h>
#include <inmoov_msgs/LeapHand.h>
#include <inmoov_msgs/LeapPointable.h>
...
struct LeapFrame_
{
  ...
  _timestamp_type timestamp;
   ...
   typedef std::vector< ::inmoov_msgs::LeapGesture_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::inmoov_msgs::LeapGesture_<ContainerAllocator> >::other >  _gestures_type;
  _gestures_type gestures;

   typedef std::vector< ::inmoov_msgs::LeapHand_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::inmoov_msgs::LeapHand_<ContainerAllocator> >::other >  _hands_type;
  _hands_type hands;

   typedef std::vector< ::inmoov_msgs::LeapPointable_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::inmoov_msgs::LeapPointable_<ContainerAllocator> >::other >  _pointables_type;
  _pointables_type pointables;




  typedef boost::shared_ptr< ::inmoov_msgs::LeapFrame_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::inmoov_msgs::LeapFrame_<ContainerAllocator> const> ConstPtr;

}; // struct LeapFrame_

typedef ::inmoov_msgs::LeapFrame_<std::allocator<void> > LeapFrame;

typedef boost::shared_ptr< ::inmoov_msgs::LeapFrame > LeapFramePtr;
typedef boost::shared_ptr< ::inmoov_msgs::LeapFrame const> LeapFrameConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::inmoov_msgs::LeapFrame_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::inmoov_msgs::LeapFrame_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::inmoov_msgs::LeapFrame_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::inmoov_msgs::LeapFrame_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::inmoov_msgs::LeapFrame_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::inmoov_msgs::LeapFrame_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::inmoov_msgs::LeapFrame_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::inmoov_msgs::LeapFrame_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::inmoov_msgs::LeapFrame_<ContainerAllocator> >
{
  ...
  static const char* value(const ::inmoov_msgs::LeapFrame_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x1be96930b5a5f7daULL;
  static const uint64_t static_value2 = 0x0ae5f4ae85fd4442ULL;
};

template<class ContainerAllocator>
struct DataType< ::inmoov_msgs::LeapFrame_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::inmoov_msgs::LeapFrame_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::inmoov_msgs::LeapFrame_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::inmoov_msgs::LeapFrame_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::inmoov_msgs::LeapFrame_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    for (size_t i = 0; i < v.gestures.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::inmoov_msgs::LeapGesture_<ContainerAllocator> >::stream(s, indent + "    ", v.gestures[i]);
    }
    ...
    for (size_t i = 0; i < v.hands.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::inmoov_msgs::LeapHand_<ContainerAllocator> >::stream(s, indent + "    ", v.hands[i]);
    }
    ...
    for (size_t i = 0; i < v.pointables.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::inmoov_msgs::LeapPointable_<ContainerAllocator> >::stream(s, indent + "    ", v.pointables[i]);
    }
  }
};
...
#endif // INMOOV_MSGS_MESSAGE_LEAPFRAME_H
