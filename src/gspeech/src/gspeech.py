...
def speech():
  rospy.init_node('gspeech')
  pubs = rospy.Publisher('speech', String, queue_size=10)
  pubs.publish("This is a test")
  pubc = rospy.Publisher('confidence', Int8, queue_size=10)
  ...
  if not error:
    pubs.publish("This is a test not errror")
    a = eval(output)
