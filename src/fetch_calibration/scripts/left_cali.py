...
GRIPPER_JOINT_NAMES = ['l_index_joint']
...
class MoveItDemo:
    def __init__(self):
      ...
      print("cali 4")
      print("==================================")
      right_arm.set_named_target('cali_4')
      right_arm.go()
      rospy.sleep(10)
      print("==================================")
      print("cali 5")
      ...
      print("cali 6")
      print("==================================")
      right_arm.set_named_target('cali_6')
      right_arm.go()
      rospy.sleep(10)
      print("==================================")
      print("cali 7")
      print("==================================")
      right_arm.set_named_target('cali_7')
      right_arm.go()
      rospy.sleep(10)
      print("==================================")
      print("cali 8")
      print("==================================")
      right_arm.set_named_target('cali_8')
      right_arm.go()
      rospy.sleep(10)
      print("==================================")
      print("cali 9")
      print("==================================")
      right_arm.set_named_target('cali_9')
      right_arm.go()
      rospy.sleep(10)
      print("==================================")
      print("cali 10")
      print("==================================")
      right_arm.set_named_target('cali_10')
      right_arm.go()
      rospy.sleep(10)
      print("==================================")
      print("resting")
