...
class CameraReconfigure(object):
    ...
    def disable_auto(self):
        self.client.update_configuration({"color_enable_auto_exposure": False,
                                          "color_enable_auto_white_balance": False})

    def enable_auto(self):
        self.client.update_configuration({"color_enable_auto_exposure": True,
