...
wrist_roll_joint_rest = rospy.get_param('/inmoov/joints/r_wrist_roll_joint/rest')
...
class ExampleApp(QtWidgets.QMainWindow, form_class):
    def __init__(self):
        ...
        self.file = open("/home/robot/baby.txt" ,"w") 
        #self.recordedfile = open("/tmp/baby.txt" ,"w")
        ...
        self.minrandomduration = 1.0
        self.maxrandomduration = 2.0
    ...
    def randomDriver(self):
        while self.running:
            ...
            while self.random == True:
                ...
                with open('/home/robot/baby1.txt') as fp:
                    for line in fp:
                        #print("testme")
                        self.commandpoint.x = float(line[0:line.index(',')])
                        self.commandpoint.y = float(line[line.index(',') + 1: len(line)])
                        #print line[0:line.index(',')]
                        #print line[line.index(',') + 1: len(line)]
                        sleep(1.0/HZ)
            sleep(1.0/HZ)
